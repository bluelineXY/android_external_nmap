...
netcat_files := base64.c  ncat_posix.c http_digest.c ncat_ssl.c   ncat_core.c      ncat_listen.c  ncat_main.c   ncat_proxy.c  util.c http.c    ncat_connect.c sys_wrap.c
...
LOCAL_SRC_FILES := $(netcat_files)
LOCAL_MODULE :=  ncat
LOCAL_CFLAGS += -O3 -DHAVE_CONFIG_H -DNOLUA -DHAVE_OPENSSL -DNCAT_DATADIR="\"/system/usr/share/ncat\""
...
LOCAL_SHARED_LIBRARIES := libssl  libcrypto libnsock libnbase
